...
YUI.add("io-form", function(e, t) {
    ...
    e.mix(e.IO.prototype, {
        _serialize: function(t, r) {
            ...
            u || (u = e.guid("io:"),
            t.id.setAttribute("id", u)),
            f = e.config.doc.getElementById(u);
            if (!f || !f.elements)
                return r || "";
            for (p = 0,
            d = f.elements.length; p < d; ++p) {
                a = f.elements[p],
                h = a.disabled,
                l = a.name;
                if (s ? l : l && !h) {
                    ...
                    switch (a.type) {
                    case "select-one":
                        a.selectedIndex > -1 && (g = a.options[a.selectedIndex],
                        i[o++] = l + n(g.attributes.value && g.attributes.value.specified ? g.value : g.text));
                        break;
                    case "select-multiple":
                        if (a.selectedIndex > -1)
                            for (v = a.selectedIndex,
                            m = a.options.length; v < m; ++v)
                                g = a.options[v],
                                g.selected && (i[o++] = l + n(g.attributes.value && g.attributes.value.specified ? g.value : g.text));
                        break;
                    case "radio":
                    case "checkbox":
                        a.checked && (i[o++] = l + c);
...
YUI.add("io-queue", function(e, t) {
    ...
    e.mix(e.IO.prototype, {
        ...
        queue: function(t, n) {
            ...
            r._qInit = !0),
            r._q.add(i),
            r._qState === 1 && r._qShift(),
            i
        },
        _qNext: function(e) {
            var t = this;
            t._qState = 1,
            t._qActiveId === e && t._q.size() > 0 && t._qShift()
        },
        qPromote: function(e) {
            this._q.promote(e)
        },
...
YUI.add("io-upload-iframe", function(e, t) {
    function u(t, n, r) {
        var i = e.Node.create('<iframe id="io_iframe' + t.id + '" name="io_iframe' + t.id + '" />');
        i._node.style.position = "absolute",
        i._node.style.top = "-1000px",
        i._node.style.left = "-1000px",
        e.one("body").appendChild(i),
        e.on("load", function() {
            r._uploadComplete(t, n)
        }, "#io_iframe" + t.id)
    }
    function a(t) {
        e.Event.purgeElement("#io_iframe" + t, !1),
        e.one("body").removeChild(e.one("#io_iframe" + t))
    }
    var n = e.config.win
      , r = e.config.doc
    ...
    e.mix(e.IO.prototype, {
        _addData: function(t, n) {
            ...
            for (u = 0,
            a = o.length - 1; u < a; u++)
                i[u] = r.createElement("input"),
                i[u].type = "hidden",
                i[u].name = s(o[u].substring(o[u].lastIndexOf("&") + 1)),
                i[u].value = u + 1 === a ? s(o[u + 1]) : s(o[u + 1].substring(0, o[u + 1].lastIndexOf("&"))),
                t.appendChild(i[u]);
            return i
        },
        ...
        _setAttrs: function(t, n, r) {
            ...
            t.setAttribute("target", "io_iframe" + n),
            t.setAttribute(e.UA.ie && !i ? "encoding" : "enctype", "multipart/form-data")
        },
        ...
        _uploadComplete: function(t, r) {
            ...
            try {
                o ? (u = o.one("pre:first-child"),
                t.c.responseText = u ? u.get("text") : o.get("text")) : t.c.responseXML = s._node
            } catch (f) {
                t.e = "upload failure"
            }
            i.complete(t, r),
        ...
        _upload: function(t, n, i) {
            ...
            return s._setAttrs(o, t.id, n),
            i.data && (u = s._addData(o, i.data)),
            i.timeout && s._startUploadTimeout(t, i),
            o.submit(),
            s.start(t, i),
            i.data && s._removeData(o, u),
            {
                id: t.id,
                abort: function() {
                    t.status = 0,
        ...
        upload: function(e, t, n) {
            ...
            return t && (n = t.form,
            n && n.upload && (i = this,
            n = typeof n.id == "string" ? r.getElementById(n.id) : n.id,
            n && i._resetAttrs(n, this._originalFormAttrs))),
            o.call(this, e, t)
        }
    }, !0)
}, "3.18.1", {
...
YUI.add("history-base", function(e, t) {
    ...
    p.SRC_ADD = c,
    p.SRC_REPLACE = h,
    p.html5 = !!(a.history && a.history.pushState && a.history.replaceState && ("onpopstate"in a || e.UA.gecko >= 2) && (!e.UA.android || e.UA.android >= 2.4)),
    p.nativeHashChange = ("onhashchange"in a || "onhashchange"in o) && (!u || u > 7),
    e.mix(p.prototype, {
        _init: function(e) {
            var t;
            e = this._config = e || {},
            this.force = !!e.force,
            t = this._initialState = this._initialState || e.initialState || null,
            this.publish(l, {
                broadcast: 2,
        ...
        _change: function(t, n, r) {
            return r = r ? e.merge(f, r) : f,
            r.merge && d(n) && d(i._state) && (n = e.merge(i._state, n)),
            this._resolveChanges(t, n, r),
            this
        },
...
YUI.add("history-html5", function(e, t) {
    ...
    e.extend(a, n, {
        _init: function(t) {
            ...
            e.Object.isEmpty(n) && (n = null),
            t || (t = {}),
            t.initialState && r.type(t.initialState) === "object" && r.type(n) === "object" ? this._initialState = e.merge(t.initialState, n) : this._initialState = n,
            e.on("popstate", this._onPopState, i, this),
            a.superclass._init.apply(this, arguments)
        },
        _storeState: function(t, n, r) {
            t !== o && i.history[t === u ? "replaceState" : "pushState"](n, r.title || e.config.doc.title || "", r.url || e.config.doc.URL),
            a.superclass._storeState.apply(this, arguments)
        },
...
YUI.add("history-hash", function(e, t) {
    ...
    e.extend(p, n, {
        _init: function(t) {
            var n = p.parseHash();
            t = t || {},
            this._initialState = t.initialState ? e.merge(t.initialState, n) : n,
            e.after("hashchange", e.bind(this._afterHashChange, this), c),
            p.superclass._init.apply(this, arguments)
        },
        ...
        _storeState: function(e, t) {
            var r = p.decode
              , i = p.createHash(t);
            p.superclass._storeState.apply(this, arguments),
            e !== u && r(p.getHash()) !== r(i) && p[e === n.SRC_REPLACE ? "replaceHash" : "setHash"](i)
        },
        ...
        parseHash: function(e) {
            ...
            i = o.length; n < i; ++n)
                s = o[n],
                u = s.split("="),
                u.length > 1 ? a[t(u[0])] = t(u[1]) : a[t(s)] = "";
            return a
        },
        replaceHash: function(t) {
            ...
            n.replace(r + "#" + (p.hashPrefix || "") + t)
        },
        setHash: function(t) {
            var n = e.getLocation();
            t.charAt(0) === "#" && (t = t.substring(1)),
            n.hash = (p.hashPrefix || "") + t
        }
    }),
    a = o._notifiers,
    a || (a = o._notifiers = []),
    ...
    f = p.getHash(),
    l = p.getUrl(),
    n.nativeHashChange ? o._hashHandle || (o._hashHandle = e.Event.attach("hashchange", function(e) {
        var t = p.getHash()
          , n = p.getUrl();
...
YUI.add("history-hash-ie", function(e, t) {
    if (e.UA.ie && !e.HistoryBase.nativeHashChange) {
        ...
        i._updateIframe = function(e, t) {
            ...
            if (!n || !r)
                return;
            t ? r.replace(e.charAt(0) === "#" ? e : "#" + e) : (n.open().close(),
            r.hash = e)
        }
        ,
        n.before(i._updateIframe, i, "replaceHash", i, !0),
        s || e.on("domready", function() {
            var t = i.getHash();
            s = r._iframe = e.Node.getDOMNode(e.Node.create('<iframe src="javascript:0" style="display:none" height="0" width="0" tabindex="-1" title="empty"/>')),
            e.config.doc.documentElement.appendChild(s),
            i._updateIframe(t || "#"),
            e.on("hashchange", function(e) {
                t = e.newHash,
                i.getIframeHash() !== t && i._updateIframe(t)
            }, o),
...
YUI.add("array-extras", function(e, t) {
    ...
    n.flatten = function(e) {
        ...
        s = e.length; i < s; ++i)
            o = e[i],
            r.isArray(o) ? t.push.apply(t, n.flatten(o)) : t.push(o);
        return t
    }
}, "3.18.1", {
    requires: ["yui-base"]
...
;
if (RightNow)
    throw Error("The RightNow namespace variable has already been defined somewhere.");
var RightNow = {
    namespace: function() {
        var a = arguments, c = null, d, g, b;
    ...
    isInstance: function(a, c) {
        return a && a instanceof c ? !0 : !1
    },
    Lang: {
        arrayFilter: function(a, c) {
            ...
            var d = [], g;
            for (g in a)
                "function" !== typeof a[g] && c(a[g]) && (d[g] = a[g]);
            return d
        },
        cloneObject: function(a) {
            ...
            if ("object" === typeof a) {
                ...
                for (var d in a)
                    "object" === typeof a[d] ? c[d] = RightNow.Lang.cloneObject(a[d]) : "string" === typeof a[d] || "number" === typeof a[d] ? c[d] = a[d] : "boolean" === typeof a[d] && (c[d] = a[d] ? !0 : !1)
            }
            return c
        }
    },
    ActionCapture: function() {
        ...
        return {
            record: function(a, c, d) {
                a = [a, c];
                null !== d && void 0 !== d && "" !== d && a.push(d.toString());
                window._rnq.push(a)
            },
            flush: function(a, c, d, g) {
                if (a) {
                    d = Math.min(d || 250, 750);
                    c = c || window;
                    g = Array.prototype.slice.call(arguments, 3);
                    var b = function() {
                        a.apply(c, g)
                    }
                      , f = setTimeout(b, d);
            ...
            instrumentation: function(a, c, d, g, b) {
                window._rnq.push([a, c, d, g, b])
            }
        }
    }()
};
    ...
    var a = YUI()
      ...
      , f = function(a, e, c) {
        ...
        this.getStatic = function() {
            return b(this.data.info.class_name)
        }
        ;
        0 < d && this.data.info && this.data.info.class_name && (RightNow.Event.fire("evt_WidgetInstantiated", {
            name: this.data.info.class_name,
            instanceID: e,
            baseSelector: this.baseSelector
        }),
        0 === --d && RightNow.Event.fire("evt_WidgetInstantiationComplete"))
    }
      , k = function(a, e, b, c) {
        for (var f in b)
            b.hasOwnProperty(f) && "constructor" !== f && (a[f] = "function" === typeof b[f] && a[f] ? function(a, b) {
                return function() {
                    this.parent = e[a];
        ...
        for (f in c)
            "overrides" === f || f in a || (a[f] = c[f])
    }
      , h = function(e) {
        var b = [];
        ("string" === typeof e ? a.Node.create(e) : e).all("script[type='text/json']").each(function(a) {
            a = a.getHTML();
            b.push(JSON.parse(a))
        });
        return b
    }
      , e = "node-core node-style node-screen node-event-delegate event-base array-extras transition history escape".split(" ")
      , m = function(e, b, c) {
        var m, d, h = function() {}, g = e + "" !== h + "";
        g && b && b.hasOwnProperty("overrides") && b.overrides && "object" === typeof b.overrides && (d = b.overrides,
        d.hasOwnProperty("constructor") && (m = function() {
            "Y"in this || f.apply(this, arguments);
            this.parent = e.prototype.constructor;
            d.constructor.apply(this, arguments);
            delete this.parent
        }
        ));
        m || (m = !g && b && b.hasOwnProperty("constructor") ? function() {
            "Y"in this || f.apply(this, arguments);
        ...
        m.prototype = new h;
        b && (d ? k(m.prototype, e.prototype, d, b) : a.mix(m.prototype, b));
        c && a.mix(m, c, !0);
        m.prototype.constructor = m;
        m.__super__ = e.prototype;
        return m
    };
    return {
        createWidgetInstance: function(f, m, d, k, h, g, r, x, y, z) {
            var u = {
                info: {
                    controller_name: f.i.c,
                    name: f.i.n,
                    w_id: f.i.w,
                    class_name: r
                },
              ...
              , s = b(r);
            m = function(b, e) {
                !b && !e || e.success ? c[h].instance = new s(u,h,b) : (YUI_config.comboBase = null,
                YUI_config.base = RightNow.Env("yuiCore"),
                YUI().use(e.data, function(e) {
                    c[h].instance = new s(u,h,e)
                }))
            }
            ;
            var v;
            f.i.t && (u.info.type = f.i.t);
            c[h] = {
                javaScriptPath: g,
                className: r,
                suffix: x
            };
            "function" === typeof s ? "requires"in s && s.requires ? (f = a.Lang.isArray(s.requires) ? s.requires : "object" === typeof s.requires && (v = RightNow.Env("module")) && a.Lang.isArray(s.requires[v]) ? s.requires[v] : [],
            a.use.apply(a, f.concat(e, [m]))) : "extend"in s ? a.use.apply(a, e.concat([m])) : m() : z && alert(RightNow.Interface.getMessage("FOLLOWING_WIDGET_JAVASCRIPT_SYNTAX_MSG") + g)
        },
        instantiateWidgetsFoundInContent: function(e) {
            a.Array.each(h(e), function(e) {
                RightNow.Widgets.createWidgetInstance(e.data, e.contextData, e.contextToken, e.timestamp, e.instanceID, e.javaScriptPath, e.className, e.suffix, e.formToken, e.showWarnings)
            })
        },
        getWidgetInformation: function(e) {
            return c[e] || null
        },
        getWidgetInstance: function(e) {
            return c[e] ? c[e].instance : null
        },
        setInitialWidgetCount: function(e) {
            d = e
        },
        ...
        extend: function(e, b) {
            var a = m(this.prototype ? this : function() {}
            , e, b);
            a.extend = this.extend;
            return a
        },
        formTokenRegistration: function(e) {
            setInterval(function() {
                RightNow.Widgets.checkFormTokenRefresh(e)
            }, 9E3);
            RightNow.Event.subscribe("evt_formTokenUpdate", this.onFormTokenUpdate, e)
        },
        checkFormTokenRefresh: function(e) {
            if (e.data.js.f_tok) {
                g = g || (new Date).getTime();
                var b = RightNow.Interface.getConfig("SUBMIT_TOKEN_EXP")
                  , b = 6E4 * (b - b / 6);
                (new Date).getTime() - g > b && (RightNow.Event.fire("evt_formTokenRequest", new RightNow.Event.EventObject(e,{
                    data: {
                        formToken: e.data.js.f_tok
                    }
                })),
                g = (new Date).getTime())
            }
        },
        onFormTokenUpdate: function(e, b) {
            var a = b[0];
            a.data.newToken && a.data.formTokenUpdateList && -1 < a.data.formTokenUpdateList.indexOf(this.instanceID) && (this.data.js.f_tok = a.data.newToken)
        }
    }
}();
RightNow.Interface = function() {
    ...
    return {
        ...
        getConfig: function(b) {
            null === c && a && (c = a());
            return c && void 0 !== c[b] ? c[b] : ""
        },
        getMessage: function(b) {
            null === d && g && (d = g());
            return d && void 0 !== d[b] ? d[b] : ""
        },
        msg: function(b, a) {
            var c = this.getMessage(a);
            return "" === c ? b : c
        },
        ASTRgetMessage: function(b) {
            return b
        },
        setConfigbase: function(b) {
            a = b
        },
        setMessagebase: function(b) {
            g = b
        }
    }
}();
RightNow.Profile = function() {
    function a(a) {
        var d = RightNow.Env("profileData");
        return d && !0 === d.isLoggedIn ? d.hasOwnProperty(a) && "undefined" !== typeof d[a] ? d[a] : "" : ""
    }
    return {
        isLoggedIn: function() {
            return RightNow.Env("profileData").isLoggedIn
        },
        isSocialUser: function() {
            return this.isLoggedIn() && null !== this.socialUserID()
        },
        contactID: function() {
            var a = RightNow.Env("profileData");
            return !0 === a.isLoggedIn ? a.contactID : null
        },
        socialUserID: function() {
            var a = RightNow.Env("profileData");
            return !0 === a.isLoggedIn ? a.socialUserID : null
        },
        firstName: function() {
            return a("firstName")
        },
        ...
        fullName: function() {
            var a = RightNow.Env("profileData");
            return !0 !== a.isLoggedIn ? "" : RightNow.Interface.getConfig("intl_nameorder") ? a.lastName + " " + a.firstName : a.firstName + " " + a.lastName
        },
        previouslySeenEmail: function() {
            return RightNow.Env("profileData").previouslySeenEmail || ""
        }
    }
}();
YUI().use("json", function(a) {
    RightNow.JSON = a.JSON
});
YUI().use("node-base", "node-core", "node-style", "dom-base", "event-base", "panel", "transition", function(a) {
    RightNow.UI = RightNow.UI || {};
    RightNow.UI = a.merge(RightNow.UI, function() {
        function c(e, a) {
            this.init(e, a)
        }
        function d(e, b) {
            a.augment(this, c, !1, null, [e, b])
        }
        function g(e, b) {
            a.augment(this, c, !1, null, [e, b])
        }
        var b = function() {
            var e = a.Node.create("<input type='hidden' id='rn_VirtualBufferUpdateTrigger' name='rn_VirtualBufferUpdateTrigger' value='1'/>");
            (new a.Node(document.body)).insert(a.Node.create('<p style="display:inline"></p>').append(e), 0);
            a.on("available", function() {
                this.set("role", "presentation").set("tabIndex", -1);
                if ("_yuiResizeMonitor" === this.get("id"))
                    try {
                        this.set("innerHTML", "&nbsp;")
                    } catch (e) {}
          ...
          , f = function(e, b) {
            for (var f = e && "object" === typeof e && e.length ? e : [e], c = b ? "addClass" : "removeClass", d = 0, k; d < f.length; d++)
                if (k = f[d])
                    if ("string" === typeof k ? k = a.one("#" === k.substr(0, 1) ? k : "#" + k) : k[c] || (k = a.one(k)),
                    k)
                        k[c]("rn_Hidden")
        };
        if ("windows" === a.UA.os && !a.UA.webkit) {
            var k = a.Node.create('<div style="display:none;background-image:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAAAAAA6fptVAAAACklEQVQIHWP4DwABAQEANl9ngAAAAABJRU5ErkJggg==);"/>')
              , h = a.one(document.body);
            h.append(k);
            "none" === k.getComputedStyle("backgroundImage") && h.addClass("rn_HighContrastMode");
            k.remove()
        }
        c.prototype = {
            init: function(e, b) {
                ...
                this.alert = this.transformNode(a.Node.create(this.render()))
            },
            types: {
                INFO: "rn_InfoAlert",
                ERROR: "rn_ErrorAlert",
            ...
            transformNode: function(e) {
                return e.setStyles(this.initialStyles)
            },
            classes: function(e) {
                return (this.types[e.toUpperCase()] || this.types.SUCCESS) + " " + this.className
            },
            parent: function() {
                return a.one(document.body)
            },
            render: function() {
                return a.Lang.sub(this.views.main, {
                    classes: this.classes(this.options.type),
                    content: this.content()
                })
            },
            content: function() {
                var e = a.Lang.sub(this.views.message, {
                    message: this.message
                });
                !0 === this.options.close && (e += a.Lang.sub(this.views.close, {
            ...
            display: function() {
                ...
                this.alert.transition(this.inTransition, this.options.focus ? a.bind(this.focus, this) : null);
                this.closeHandler();
                this.clickHandler();
                this.blurHandler();
            ...
            closeHandler: function() {
                ...
                if ("number" === typeof e)
                    a.Lang.later(e, this, this.destroy);
                else if (!0 === e)
            ...
            blurHandler: function() {
                this.alert.on("blur", function() {
                    a.UA.ie || this.eventTarget.fire("blur")
                }, this)
            },
            destroy: function() {
                this.eventTarget.fire("close");
                this.options.focus && a.UA.ie && this.eventTarget.fire("blur");
                this.alert.transition(this.outTransition, a.bind(function() {
                    this.alert.remove();
                    this.alert = null
                }, this));
            ...
            focusLastElement: function() {
                if (this.options.focus && (this.options.focusElement || this.options.baseClass))
                    if (null !== this.options.focusElement && "object" === typeof this.options.focusElement)
                        this.options.focusElement.set("tabIndex", 0).focus();
                    else {
                        var e = a.one(this.options.baseClass);
                        if (e) {
                            var b = e.get("children");
                            0 < b.size() ? (e = b.item(0),
                            (b = e.one("a, input, select, button")) ? b.focus() : e.set("tabIndex", 0).focus()) : e.set("tabIndex", 0).focus()
                        }
                    }
            }
        };
        ...
        g.prototype = {
            ...
            parent: function() {
                ...
                return e.one ? e : a.one(e)
            }
        };
        g.prototype.initialStyles = g.prototype.outTransition;
        return {
            updateVirtualBuffer: function() {
                var e = b || a.one("#rn_VirtualBufferUpdateTrigger")
                  , f = e ? "1" === e.get("value") ? "0" : "1" : null;
                f && e.set("value", f)
            },
            addDevelopmentHeaderError: function(e) {
                RightNow.UI.DevelopmentHeader && RightNow.UI.DevelopmentHeader.addJavascriptError(e)
            },
            addDevelopmentHeaderWarning: function(e) {
                RightNow.UI.DevelopmentHeader && RightNow.UI.DevelopmentHeader.addJavascriptWarning(e)
            },
            changeChildCssClass: function(e, b) {
                a.one(e).all("*").each(function(e) {
                    e.get("className") && e.addClass(b)
                })
            },
            findParentForm: function(e) {
                e = a.one(0 === e.indexOf("#") ? e : "#" + e);
                var b;
                return e && (e = "FORM" === e.get("tagName") ? e : e.ancestor("form")) && (b = e.get("id")) && 0 !== b.indexOf("yui_3_") ? b : null
            },
            getInputFieldByColumnName: function(e, b) {
                var a = new RegExp("^" + e);
                "object" !== typeof b && null !== b && (b = document.getElementById(b));
                for (var f = 0; f < b.elements.length; f++)
                    if (b.elements[f] && b.elements[f].name && a.test(b.elements[f].name))
                        return f;
                return null
            },
            toggleVisibilityAndText: function(b, a, f, c) {
                if (b = document.getElementById(b))
                    "none" === b.style.display ? (b.style.display = "block",
                    document.getElementById(a).innerHTML = f) : "block" === b.style.display && (b.style.display = "none",
            ...
            displayAlertBox: function(b, f) {
                ...
                if (!f.parent)
                    throw Error("A parent element to insert the alert box into must be specified via `options.parent`");
                return (new g(b,f)).display()
            },
            displayBanner: function(b, f) {
                f = a.mix(f || {}, {
                    close: 4E3,
                    focus: !0,
                    type: "SUCCESS"
                ...
                case "SUCCESS":
                    b = RightNow.Text.sprintf(RightNow.Interface.getMessage("SUCCESS_S_LBL"), b);
                    break;
                case "ERROR":
                    b = RightNow.Text.sprintf(RightNow.Interface.getMessage("ERROR_PCT_S_LBL"), b);
                    break;
                case "WARNING":
                    b = RightNow.Text.sprintf(RightNow.Interface.getMessage("WARNING_S_LBL"), b);
                    break;
                case "INFO":
                    b = RightNow.Text.sprintf(RightNow.Interface.getMessage("INFORMATION_S_LBL"), b)
                }
                return (new d(b,f)).display()
            },
            Form: {
                currentProduct: 0,
                logoutInProgress: !1,
    ...
    RightNow.UI.Dialog = function() {
        var c = 0
          ...
          , g = function() {
            ...
            a.DOM.addHTML(document.body, b, document.body.firstChild);
            return b
        }()
          , b = function(b) {
            var f = [];
            a.Array.each(b, function(b) {
                f.push({
                    label: b.text,
                    action: b.handler && b.handler.scope && b.handler.fn ? RightNow.Event.createDelegate(b.handler.scope, b.handler.fn) : b.handler,
                    classNames: b.cssClass,
                    href: b.href,
          ...
          , f = function(b) {
            b.id = b.get("contentBox").get("id");
            b.cfg = {
                getProperty: function(a) {
                    return b.get(a)
                },
                setProperty: function(a, f) {
                    return b.set(a, f)
                }
            };
            var f = {}
              ...
              , k = function(a) {
                var c = 0;
                for (a = f[a] || []; c < a.length; c++)
                    a[c].handler.call(a[c].context || b, a[c].args)
            };
            b.hideEvent = {
                subscribe: function(b, a, e) {
                    c("hide", b, a, e)
                }
            };
            b.showEvent = {
            ...
            b.after("visibleChange", function(b) {
                k(b.newVal ? "show" : "hide");
                RightNow.UI.updateVirtualBuffer()
            });
            b.onCancel = function(b) {
                b.preventDefault();
                this.hide();
                k("cancel")
            }
            ;
            b.disableButtons = function() {
                RightNow.UI.Dialog.disableDialogButtons(this)
            }
            ;
            b.enableButtons = function() {
                RightNow.UI.Dialog.enableDialogButtons(this)
            }
            ;
            b.enableSecondButton = function() {
                var b = this.getStdModNode(a.WidgetStdMod.FOOTER).all("button").item(1);
                b && b.removeAttribute("disabled")
            }
            ;
            b.getButtons = function() {
                return this.getStdModNode(a.WidgetStdMod.FOOTER).all("button")
            }
            ;
            b.setFooter = function(b) {
                this.set("footerContent", b)
            }
            ;
            b.setHeader = function(b) {
                this.set("headerContent", b)
            }
            ;
            b.setBody = function(b) {
                this.set("bodyContent", b)
            }
            ;
            return b
        }
          , k = function(b, f, c) {
            var k = b.getStdModNode(a.WidgetStdMod.FOOTER).one(".yui3-button-primary") || b.getButtons().item(0);
            k && (c = c ? RightNow.Interface.getMessage("DIALOG_LBL") + ". " + c.get("text") : RightNow.Interface.getMessage("DIALOG_PLEASE_READ_TEXT_DIALOG_MSG_MSG"),
            k.set("innerHTML", '<span class="rn_ScreenReaderOnly">' + f + " " + c + " </span>" + k.getHTML()),
            b.after("visibleChange", function(b) {
                if (b.newVal)
                    try {
                        a.Lang.later(400, k, "focus")
                    } catch (e) {}
            }))
        }
          , h = function(e, k, d) {
            ...
            d.buttons || (d.buttons = [{
                ...
                handler: d.exitCallback || function() {
                    this.hide()
                }
                ,
                isDefault: !0
            ...
            d.hasOwnProperty("close") && !d.close || k.addButton({
                name: "close",
                label: RightNow.Interface.getMessage("CLOSE_CMD"),
                action: d.exitCallback || "onCancel"
            }, n.HEADER);
            var q = "rn_Dialog_" + c + "_Title";
            k.setStdModContent(n.HEADER, a.Lang.sub('<span class="rn_ScreenReaderOnly">{text}</span>', {
                text: RightNow.Interface.getMessage("BEG_DIALOG_PLS_DISMISS_DIALOG_BEF_MSG")
            }) + " <h2 id='" + q + "' class ='rn_DialogTitle'>" + e + "</h2>", n.BEFORE);
            k.get("contentBox").set("id", h).addClass(a.Lang.trim("rn_Dialog " + (d.cssClass || "")));
            k.get("boundingBox").setAttribute("aria-labelledby", q);
            k.on("widget:render", RightNow.UI.updateVirtualBuffer);
            k.render(g);
            k.setStdModContent(n.FOOTER, a.Lang.sub('<span class="rn_ScreenReaderOnly">{text}</span>', {
                text: RightNow.Interface.getMessage("END_DIALOG_PLS_DISMISS_DIALOG_BEF_MSG")
            }), n.AFTER);
            document.activeElement && k.after("visibleChange", function(b) {
                if (!b.newVal)
                    try {
        ...
        return {
            actionDialog: function(b, f, c) {
                if (!f || !f.nodeType && !f.get)
                    return null;
                f = h(b, f, c);
                f.get("contentBox").addClass("rn_ActionDialog");
                c && c.hideOnEnterKeyPress && !0 === c.hideOnEnterKeyPress && this.addDialogEnterKeyListener(f, f.hide);
                var d = f.getStdModNode(a.WidgetStdMod.BODY).one("input, textarea, select")
                  , g = c && c.dialogDescription ? a.one("#" + c.dialogDescription) : null;
                if (d && d.get("id")) {
                    var q = f.getStdModNode(a.WidgetStdMod.BODY).one('label[for="' + d.get("id") + '"]');
                    c && c.dialogDescription && (g && g.setAttribute("tabindex", -1),
                    f.get("contentBox").setAttribute("aria-describedby", c.dialogDescription));
                    q && a.UA.ie && (q.prepend('<span class="rn_ScreenReaderOnly">' + b + " " + RightNow.Interface.getMessage("DIALOG_LBL") + " </span>"),
                    c && c.dialogDescription && d.setAttribute("aria-describedby", c.dialogDescription));
                    f.after("visibleChange", function(b) {
                        if (b.newVal)
                            try {
                                d.focus()
                            } catch (a) {}
                    ...
                    k(f, b, g);
                f.get("boundingBox").setAttribute("role", "dialog");
                return f
            },
            addDialogEnterKeyListener: function(b, f, c, k) {
                if (!b || !f)
                    return null;
                var h = a.delegate("key", function(a) {
                    a.target && "BUTTON" === a.target.get("tagName") || f.call(c || b, "keyPressed", [RightNow.UI.KeyMap.ENTER, a])
                }, "#" + b.get("id"), "down:" + RightNow.UI.KeyMap.ENTER, k);
                d[b.id] || (d[b.id] = {});
                d[b.id][h.sub.id] = {
                    context: c,
                    fn: f,
            ...
            disableDialogButtons: function(b) {
                b.getStdModNode(a.WidgetStdMod.FOOTER).all("button").set("disabled", !0)
            },
            disableDialogControls: function(b, a) {
                this.disableDialogKeyListener(b, a);
                this.disableDialogButtons(b)
            },
            disableDialogKeyListener: function(b, a) {
                if (!b || !a)
                    return null;
                var f = b.id;
                d[f] || (d[f] = {});
                d[f][a.sub.id] && (d[f][a.sub.id].attached = !1);
                a.detach()
            },
            enableDialogButtons: function(b) {
                b.getStdModNode(a.WidgetStdMod.FOOTER).all("button").removeAttribute("disabled")
            },
            enableDialogControls: function(b, a, f) {
                this.enableDialogKeyListener(b, a);
                this.enableDialogButtons(b);
                f && f.focus()
            },
            enableDialogKeyListener: function(b, a) {
                if (!b || !a)
                    return null;
                var f = a.sub.id;
                (f = d[b.id] ? d[b.id][f] : null) && !f.attached && this.addDialogEnterKeyListener(b, f.fn, f.context, f.selector)
            },
            messageDialog: function(b, f) {
                if (!b)
                    return null;
                f || (f = {});
                f.width || (f.width = "20em");
                var d = {
                    HELP: {
                ...
                }, g = d[f.icon] || d.defaults, d = f.title || g.title || "", n = g.className, q;
                q = f.exitCallback || f.focusElement ? function(b) {
                    this.hide();
                    f.exitCallback && "function" === typeof f.exitCallback ? f.exitCallback(f.focusElement) : f.exitCallback && f.exitCallback.fn && f.exitCallback.scope ? f.exitCallback.fn.call(f.exitCallback.scope, f.focusElement) : f.focusElement && (b = "string" === typeof f.focusElement ? document.getElementById(f.focusElement) : f.focusElement) && b.focus && b.focus()
                }
                : function() {
                    this.hide()
                }
                ;
                var t = a.Node.create("<span>" + b + "</span>")
                  , g = h(d, t, {
                    width: f.width,
                    exitCallback: q
                });
                g.get("contentBox").setAttribute("aria-describedby", t.set("id", "rn_Dialog_" + c + "_Message").get("id")).addClass("rn_MessageDialog");
                g.get("boundingBox").setAttribute("role", "alertdialog");
                t.insert("<span class='rn_MessageDialogIcon " + n + "'></span>", "before");
                g.cancelEvent.subscribe(q);
                n = f && f.dialogDescription ? a.one("#" + f.dialogDescription) : a.one("#rn_Dialog_" + c + "_Message");
                k(g, d, n);
                a.UA.ie ? a.Lang.later(400, g, "show") : g.show();
                return g
            }
        }
    }()
...
if (RightNow.Ajax)
    throw Error("The RightNow.Ajax namespace variable has already been defined somewhere.");
YUI().use("io-base", "io-form", "io-queue", "io-upload-iframe", function(a) {
    RightNow.Ajax = function() {
        ...
        var d = {}
          , g = {}
          , b = !1;
        a.io.header("RNT_REFERRER", c(window.location.href));
        return {
            getRntReferrerHeaderFromUrl: c,
            MAX_URL_LENGTH: 2048,
            addRequestData: function(b, a, c) {
                c ? g[b] = a : d[b] = a
            },
            convertObjectToPostString: function(b) {
                var a = "", c;
                for (c in b)
                    b.hasOwnProperty(c) && "function" !== typeof b[c] && "object" !== typeof b[c] && void 0 !== b[c] && (a += encodeURIComponent(c) + "=" + encodeURIComponent(b[c]) + "&");
                0 < a.length && (a = a.substring(0, a.length - 1));
                return a
            },
            convertObjectToGetString: function(b) {
                var a = "", c, e;
                for (c in b)
                    e = b[c],
                    b.hasOwnProperty(c) && "function" !== typeof e && "object" !== typeof e && "undefined" !== typeof e && null !== e && "" !== e && (a += "/" + encodeURIComponent(c) + "/" + encodeURIComponent(e));
                return a
            },
            makeRequest: function(f, c, h) {
                "undefined" !== typeof h && h || (h = {});
                if (!0 === h.cors && !h.xdrLoaded && a.UA.ie && 10 > a.UA.ie) {
                    var e = {};
                    a.use("io-xdr", function(b) {
                        h.xdrLoaded = !0;
                        e = RightNow.Ajax.makeRequest(f, c, h)
                    });
                    return e
                }
                h.type = h.type || "POST";
                h.url = f;
                h.post = a.merge(c || {}, d, g);
                d = {};
                RightNow.Event.fire("on_before_ajax_request", h);
                h.data = RightNow.Lang.cloneObject(h.data);
                "GETPOST" === h.type && h.url !== f && (h.type = "POST");
                var m = {
                    failureHandler: h.failureHandler || this.genericFailure
                }, p, l;
                h.upload && (h.type = "POST");
                h.scope && (p = h.scope);
                null !== h.data && "undefined" !== typeof h.data && (l = h.data);
                h.challengeHandler || (h.challengeHandler = (new RightNow.UI.AbuseDetection.Default).getChallengeHandler());
                h.successHandler || (h.successHandler = this.genericSuccess);
                var n = h.successHandler
                  , q = function(b, a, f) {
                    var c, e = RightNow.Interface.getMessage("THERE_PROB_REQ_ACTION_COULD_COMPLETED_MSG"), d = function(b) {
                        m.failureHandler.call(p || window, {
                            ajaxError: b
                        }, a, f)
                    };
                    try {
                        c = RightNow.JSON.parse(b.responseText);
                        if (!0 === h.isResponseObject || !0 === c.isResponseObject)
                            if (c.errors && c.errors.length && d(c.errors[0].displayToUser ? c.errors[0].externalMessage : e),
                            c = c.result,
                            !c)
                                return;
                        c._isParsed = !0
                    ...
                    n.call(p || window, c, a, f)
                };
                !0 === h.json && "" + n !== "" + q && (h.successHandler = q);
                "" !== RightNow.Url.getSession() && (/getChatQueueAndInformation/.test(f) ? /getChatQueueAndInformation/.test(f) && !0 !== h.data.data.cookies_enabled && (h.url = RightNow.Url.addParameter(h.url, "session", RightNow.Url.getSession())) : h.url = RightNow.Url.addParameter(h.url, "session", RightNow.Url.getSession()));
                m.success = function(b, a, f) {
                    if (RightNow.UI.AbuseDetection.doesResponseIndicateAbuse(a))
                        try {
                            h.challengeHandler(RightNow.JSON.parse(RightNow.Text.getSubstringAfter(a.responseText, "\n")), h, RightNow.UI.AbuseDetection.isRetry())
                        } catch (c) {
                            RightNow.UI.Dialog.messageDialog(RightNow.Interface.getMessage("THERE_PROB_REQ_ACTION_COULD_COMPLETED_MSG"), {
                                icon: "WARN"
                            })
                        }
                    else
                        RightNow.Ajax.checkForSocialExceptions(a),
                        a.getResponseHeader && "application/json" === a.getResponseHeader("content-type") && "" + n !== "" + q && (h.successHandler = q),
                        h.successHandler.call(this, a, f, b)
                }
                ;
                m.failure = function(a, e, d) {
                    0 === e.status && "timeout" === e.statusText && (RightNow.ActionCapture.record("cpAjax", "timeout", {
                        url: f,
                        method: h.type,
                        payload: c
                    }),
                    e.suggestedErrorMessage = RightNow.Interface.getMessage("REQUEST_COL_PCT_ED_HEAVY_SYS_L_RR_AGAIN_MSG"));
                    b || m.failureHandler.call(this, e, d)
                }
                ;
                l = {
                    on: m,
                    timeout: h.timeout || 2E4,
                    arguments: l,
                    context: p
                };
                !0 === h.cors && (l.xdr = {
                ...
                if ("GETPOST" === h.type) {
                    var t = ("/" === h.url.charAt(h.url.length - 1) ? h.url.substring(0, h.url.length - 1) : h.url) + this.convertObjectToGetString(h.post);
                    if (t.length < this.MAX_URL_LENGTH)
                        return l.method = "GET",
                        a.io(t, l)
                }
                l.data = this.convertObjectToPostString(h.post) || void 0;
                l.method = "GETPOST" === h.type ? "POST" : h.type;
                h.upload && (l.on.complete = m.success,
                l.form = {
                    id: h.upload,
                    upload: !0
                });
                a.io.header("X-Requested-With", "xmlhttprequest");
                h.headers && (l.headers = h.headers);
                return a.io(h.url, l)
            },
            genericSuccess: function(b, a) {
                if ("object" === typeof b && ("responseText"in b || "_isParsed"in b)) {
                    var c = "";
                    if ("_isParsed"in b)
                        delete b._isParsed,
                        c = b;
                    ...
                    a && a.eventName && RightNow.Event.fire(a.eventName, c, a.data)
                } else
                    RightNow.UI.Dialog.messageDialog(RightNow.Interface.getMessage("THERE_PROB_REQ_ACTION_COULD_COMPLETED_MSG"), {
                        icon: "WARN"
                    })
            },
            genericFailure: function(b) {
                b.ajaxError ? RightNow.UI.Dialog.messageDialog(b.ajaxError, {
                    icon: "WARN"
                }) : 0 === b.status || "timeout" === b.statusText ? RightNow.UI.Dialog.messageDialog(RightNow.Interface.getMessage("REQUEST_COL_PCT_ED_HEAVY_SYS_L_RR_AGAIN_MSG"), {
                    icon: "WARN"
                }) : b.argument && b.argument.ignoreFailure || RightNow.UI.Dialog.messageDialog(RightNow.Interface.getMessage("THERE_PROB_REQ_ACTION_COULD_COMPLETED_MSG"), {
                    icon: "WARN"
                })
            },
            abortRequest: function(b, a) {
                if (b.abort) {
                    if (a)
                        b.on("failure", a);
                    b.abort();
            ...
            setIsNavigatingAwayFromPage: function(a) {
                b = a
            },
            checkForSocialExceptions: function(b) {
                if ("null" !== b.responseText)
                    try {
                        var c = RightNow.JSON.parse(b.responseText);
                        c.errors && 0 < c.errors.length && a.Array.each(c.errors, function(b) {
                            "ERROR_USER_NOT_LOGGED_IN" === b.errorCode && RightNow.Event.fire("evt_requireLogin");
                            "ERROR_USER_HAS_NO_SOCIAL_USER" !== b.errorCode && "ERROR_USER_HAS_BLANK_SOCIAL_USER" !== b.errorCode || RightNow.Event.fire("evt_userInfoRequired")
                        })
                    } catch (d) {}
            },
            indicatesSocialUserError: function(b) {
                var c = [];
                "object" === typeof b ? b.responseText && "undefined" !== b.responseText ? c.push(b.responseText) : b.errors && "undefined" !== b.errors && a.Array.each(b.errors, function(b) {
                    c.push(b.errorCode)
                }) : "string" === typeof b && c.push(b);
                return a.Array.some(c, function(b) {
                    if (/ERROR_USER_NOT_LOGGED_IN|ERROR_USER_HAS_NO_SOCIAL_USER|ERROR_USER_HAS_BLANK_SOCIAL_USER/.test(b) || /User is not logged in|User does not have a display name/.test(b))
                        return !0
                })
            }
        }
    ...
    RightNow.Ajax.CT = function() {
        var a = []
          , d = function(d, b) {
            a && a.length && RightNow.Ajax.makeRequest(RightNow.Ajax.CT.DQA_SERVICE, {
                data: RightNow.JSON.stringify(a)
            }, {
                successHandler: d || function() {}
                ,
                failureHandler: d || function() {}
                ,
                scope: b
            });
            a = []
        ...
        return {
            ...
            WIDGET_STATS: 9,
            GA_SESSIONS: 11,
            GA_SESSION_DETAILS: 12,
            DQA_SERVICE: "/ci/dqa/publish",
            addAction: function(d, b) {
                a.push({
                    type: d,
                    action: b
                })
            },
            commitActions: function(a, b) {
                d(a, b)
            },
            submitAction: function(a, b, c, k) {
                this.addAction(a, b);
                d(c, k)
            }
        }
    ...
    (function() {
        ...
        window.onbeforeunload = function(d) {
            a && a(d);
            RightNow.Ajax.setIsNavigatingAwayFromPage(!0)
        }
    }
    )()
});
if (RightNow.Url)
    throw Error("The RightNow.Url namespace variable has already been defined somewhere.");
RightNow.Url = function() {
    var a = YUI()
      ...
      , g = function(b) {
        var c = [];
        a.Object.each(b, function(b) {
            "string" === typeof b && (b = b.split(","));
            a.Lang.isArray(b) && (b = b[b.length - 1]);
            "string" !== typeof b && "number" !== typeof b || c.push(b)
        });
        return c ? c.join(";") : null
    };
    return {
        addParameter: function(b, a, c, d) {
            if (null == c)
                return b;
            if ("" === c)
                return RightNow.Url.deleteParameter(b, a);
            var e = b.indexOf("#"), g = !1, p;
            0 <= e && (p = b.substr(e),
            b = b.substr(0, e),
            g = !0);
            if (0 < c.toString().length) {
                var l;
                c = encodeURIComponent("." === c || ".." === c ? " " + c : c);
                if ("p" === a || "c" === a)
                    c = c.replace("%3B", ";");
                "kw" === a && "session" === c && (c = "%73%65%73%73%69%6f%6e");
                0 <= b.indexOf("?") ? (e = new RegExp("&" + a + "=[^&]+"),
                a = "&" + a + "=",
                l = "&") : (e = new RegExp("/" + a + "/[^/]+"),
                a = "/" + a + "/",
                l = "/");
                0 <= b.indexOf(a) ? d || (b = b.replace(e, a + c)) : (b.charAt(b.length - 1) === l && (b = b.substr(0, b.length - 1)),
                b += a + c)
            }
            return g ? b + p : b
        },
        buildUrlLinkString: function(b, a) {
            for (var c = "", d = a ? a.split(",") : b.format && b.format.parmList ? b.format.parmList.split(",") : [], e = b.filters || b, m = 0; m < d.length; m++) {
                var p = d[m]
                  , l = d[m]
                  , n = this.getParameter(p);
                null !== n && "function" !== typeof n && (c = this.addParameter(c, p, n));
                l = "kw" === l ? "keyword" : l;
                l = "st" === l ? "searchType" : l;
                l = "sort" === l ? "sort_args" : l;
                if ("page" === l)
                    e[l] && (c = this.addParameter(c, l, e[l]));
                else if (e[l] && e[l].filters && null != e[l].filters.data) {
                    var q = e[l].filters.data
                      , n = null != q.val ? q.val : q;
                    if ("sort_args" === l)
                        n = 0 < q.col_id ? q.col_id + "," + (q.sort_direction || 1) : null;
                    else if ("org" === l)
                        n = q.selected;
                    else if ("p" === l || "c" === l)
                        n = g(n);
                    if ("boolean" === typeof n || "string" === typeof n || "number" === typeof n)
                        c = this.addParameter(c, p, n)
                }
            }
            return c
        },
        convertSearchFiltersToParms: function(b, a, c) {
            var h = {
                keyword: "kw",
                locale: "loc",
                searchType: "st",
            ...
            for (e in a)
                if ("function" !== typeof a[e]) {
                    var m = h[e] ? h[e] : e
                      , p = null
                      , l = null;
                    a[e] && a[e].filters && (l = a[e].filters);
                    if ("keyword" === e)
                        p = l.data;
                    else if ("page" === e && a[e])
                        p = a[e];
                    else if ("locale" === e && a[e])
                        p = a[e];
                    else if ("sort_args" === e) {
                        var n = l.data && l.data.col_id ? l.data.col_id : l.col_id
                          , l = l.data && l.data.sort_direction ? l.data.sort_direction : l.sort_direction;
                        void 0 !== n && (p = -1 == n ? null : n + "," + l)
                    } else
                        "p" === e || "c" === e || "pc" === e || "asset_id" === e ? p = g(l.data) : "org" === e && l && l.data && null != l.data.selected ? p = l.data.selected : l && null != l.data && (p = l.data.val || l.data);
                    if ("boolean" === typeof p || "string" === typeof p || "number" === typeof p)
                        b = this.addParameter(b, m, p)
                }
            "" !== d && null != c && (b = this.addParameter(b, "sno", c));
            return b
        },
        convertToArray: function(b, a) {
            if ("undefined" === typeof b || isNaN(parseInt(b, 10)))
                b = c;
            var d = (a || window.location.pathname).replace(/\/+/g, "/")
              , g = []
              , e = d.split("/");
            a && "/" === a[0] && e.shift();
            if (1 < e.length)
                for (d = /^\/ci\//.test(d) ? b : b - 1; d < e.length; d += 2)
                    d + 1 < e.length && (g[e[d]] = decodeURIComponent(e[d + 1]));
            return g
        },
        convertToSegment: function(b) {
            var a = "", c;
            for (c in b)
                b.hasOwnProperty(c) && b[c] && (a += "/" + c + "/" + encodeURIComponent(b[c]));
            return a
        },
        deleteParameter: function(b, a) {
            return 0 <= b.indexOf("/" + a + "/") ? b.replace(new RegExp("/" + a + "/[^#/]+"), "") : b
        },
        getSession: function() {
            return d
        },
        ...
        getParameter: function(b) {
            return this.convertToArray(this.getParameterSegment())[b] || null
        },
        getUrlParametersFromList: function(b, a) {
            void 0 === a && (a = []);
            for (var c = "", d = b.replace(/ /g, "").split(","), e = 0; e < d.length; e++) {
                for (var g = !1, p = 0; p < a.length; p++)
                    if (a[p] === d[e]) {
                        g = !0;
                        break
                    }
                g || (g = this.getParameter(d[e]),
                null !== g && (c += "/" + d[e] + "/" + g))
            }
            return c
        },
        isSameUrl: function(b) {
            var a = window.location.pathname;
            "/" !== a.charAt(a.length - 1) && (a += "/");
            "/" !== b.charAt(b.length - 1) && (b += "/");
            return a.substring(0, b.length) === b
        },
        isExternalUrl: function(b) {
            return -1 === b.indexOf(window.location.host)
        },
        navigate: function(b, a) {
            a || "" === this.getSession() || (b = this.addParameter(b, "session", this.getSession()));
            window.location.pathname === b || RightNow.Text.beginsWith(b.toLowerCase(), "javascript:") ? window.location.reload(!0) : window.location = b
        },
        setParameterSegment: function(b) {
            c = b
        },
...
YUI().use("node-core", "event-base", function(a) {
    function c(a) {
        var b = a.get("href");
        if (!("" === b || "" !== a.get("hostname") && a.get("hostname") !== window.location.hostname || -1 < b.indexOf("doc_view.php") || -1 < b.indexOf("doc_submit.php") || -1 < b.indexOf("doc_serve.php") || -1 < b.indexOf("verify_acct_login.php") || -1 < b.indexOf("/ci/") && -1 === b.indexOf("/ci/opensearch") || -1 < b.indexOf("qautils.php"))) {
            var b = b.split("#")
              , c = a.get("innerHTML")
              , k = RightNow.Text;
            "/" === b[0].substr(-1) && (b[0] = b[0].slice(0, -1));
            "/" === d.substr(-1) && (d = d.slice(0, -1));
            void 0 !== b[1] && b[0] === d && (a.set("href", window.location.pathname + "#" + b[1]),
            -1 < c.indexOf("@") && a.set("innerHTML", c));
            if ("" !== RightNow.Url.getSession() && b[0] !== d) {
                var b = a.get("href")
                  , h = k.getSubstringAfter(a.get("href"), a.get("hostname") || window.location.hostname)
                  , e = RightNow.Interface.getConfig("CP_HOME_URL");
                "" === h ? a.set("href", b + "/app/" + e) : "/" === h ? a.set("href", b + "app/" + e) : "/app" === h ? a.set("href", b + "/" + e) : "/app/" === h && a.set("href", b + e);
                (h = k.getSubstringAfter(a.get("href"), a.get("hostname") || window.location.hostname)) && (k.beginsWith(b, "http://") || k.beginsWith(b, "https://") || k.beginsWith(b, "/")) && (k.beginsWith(h, "/app/") || k.beginsWith(h, "/ci/") || k.beginsWith(h, "/cc/")) && a.set("href", RightNow.Url.addParameter(a.get("href"), "session", RightNow.Url.getSession()));
                -1 < c.indexOf("@") && a.set("innerHTML", c)
            }
        }
    }
    var d;
    RightNow.Url.transformLinks = function(g) {
        d = (d = a.one("base")) ? d.get("href") : "";
        (g && g._yuid ? g : a.one(g || document.body)).all("a").each(c)
    }
    ;
...
if (RightNow.Text)
    throw Error("The RightNow.Text namespace variable has already been defined somewhere.");
RightNow.Text = {
    getSubstringAfter: function(a, c) {
        var d = a.indexOf(c);
        return -1 === d ? !1 : a.substr(d + c.length)
    },
    getSubstringBefore: function(a, c) {
        var d = a.indexOf(c);
        return -1 === d ? !1 : a.substr(0, d)
    },
    getSubstringBetween: function(a, c, d) {
        var g = c.length;
        c = a.indexOf(c) + g;
        d = a.indexOf(d, c);
        return c === g - 1 ? !1 : a.substring(c, d > c ? d : a.length)
    },
    beginsWith: function(a, c) {
        return a.substr(0, c.length) === c
    },
    sprintf: function(a) {
        var c = 1
          , d = arguments;
        return a.replace(/%[%sd]/g, function(a, b, f) {
            if ("%%" === a)
                return "%";
            if (c >= d.length)
                throw Error("RightNow.Text.sprintf: More placeholders (" + c + ") are present in the format string ('" + f + "') than arguments (" + (d.length - 1) + ") were provided.");
            return d[c++]
        })
    },
    trimComma: function(a) {
    ...
    isValidEmailAddress: function(a) {
        var c = RightNow.Interface.getConfig("DE_VALID_EMAIL_PATTERN");
        if (80 < this.Encoding.utf8Length(a))
            return !1;
        if (c)
            return this.isValidEmailAddress._emailRegex = this.isValidEmailAddress._emailRegex || new RegExp("^" + decodeURIComponent(escape(c)) + "$","i"),
            this.isValidEmailAddress._emailRegex.test(a);
        this.isValidEmailAddress._emailRegexApi = this.isValidEmailAddress._emailRegexApi || new RegExp("^" + RightNow.Interface.Constants.API_VALIDATION_REGEX_EMAIL + "$","i");
        return this.isValidEmailAddress._emailRegexApi.test(a)
    },
    isValidUrl: function(a) {
        this.isValidUrl._protocol = this.isValidUrl._protocol || "^[a-z][a-z0-9.+-]+://";
        this.isValidUrl._protocolRegex = this.isValidUrl._protocolRegex || new RegExp(this.isValidUrl._protocol,"i");
        this.isValidUrl._urlRegex = this.isValidUrl._urlRegex || new RegExp(this.isValidUrl._protocol + "(?:(?:[^\x00- \u007f<>/]+\\.(?:[^\x00- \u007f<>/]+)|\\[[0-9a-f:]+])(?::[0-9]+)?)[^\x00- \u007f]*$","i");
        this.isValidUrl._protocolRegex.test(a) || (a = "http://" + a);
        return this.isValidUrl._urlRegex.test(a)
    },
    slugify: function(a) {
        return a.replace(/^\s+|\s+$|['`"]/g, "").replace(/[\s~!@#$%^&*()_+={}\[\]:;<>,.?\/\\|]/g, "-").replace(/\-+/g, "-").toLowerCase()
    },
    stripTags: function(a, c) {
        c = (((c || "") + "").toLowerCase().match(/<[a-z][a-z0-9]*>/g) || []).join("");
        return a.replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>/gi, function(a, g) {
            return -1 < c.indexOf("<" + g.toLowerCase() + ">") ? a : ""
        })
    }
};
    ...
    return {
        base64Decode: function(a) {
            ...
            for (var c = [], d = 0; d < a.length; ) {
                var g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".indexOf(a.charAt(d++))
                  , b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".indexOf(a.charAt(d++));
                c.push(String.fromCharCode(g << 2 | b >> 4));
                g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".indexOf(a.charAt(d++));
                if (64 === g)
                    break;
                c.push(String.fromCharCode((b & 15) << 4 | g >> 2));
                b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".indexOf(a.charAt(d++));
                64 !== b && c.push(String.fromCharCode((g & 3) << 6 | b))
            }
            return this.utf8Decode(c.join(""))
        },
        base64Encode: function(a) {
            a = this.utf8Encode(a);
            for (var c = [], d = 0; d < a.length; ) {
                var g = a.charCodeAt(d++);
                c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".charAt(g >> 2));
                var b = a.charCodeAt(d++);
                c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".charAt((g & 3) << 4 | b >> 4));
                isNaN(b) ? (c.push("."),
                c.push(".")) : (g = a.charCodeAt(d++),
                c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".charAt((b & 15) << 2 | g >> 6)),
                isNaN(g) ? c.push(".") : c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/.".charAt(g & 63)))
            }
            return c.join("")
        },
        getAsciiPrefix: function(a) {
            for (var c = 0; c < a.length && !(128 <= a.charCodeAt(c)); ++c)
                ;
            return c >= a.length ? a : a.substring(0, c)
        },
        utf8Decode: function(a) {
            var c = this.getAsciiPrefix(a);
            if (c.length === a.length)
                return c;
            for (var d = [], g, b, f = c.length; f < a.length; ++f) {
                var k = a.charCodeAt(f);
                if (128 > k)
                    d.push(String.fromCharCode(k));
                else {
                    if (192 > k)
                        throw Error("I can't decode the character at index " + f + " of " + a + " because it's not a valid UTF8 sequence.");
                    if (224 > k) {
                        if (a.length <= ++f)
                            throw Error("I can't decode the character at index " + f + " of " + a + " because it's not a valid UTF8 sequence.");
                        g = a.charCodeAt(f);
                        d.push(String.fromCharCode((k & 31) << 6 | g & 63))
                    } else {
                        g = a.charCodeAt(++f);
                        b = a.charCodeAt(++f);
                        if (a.length <= f)
                            throw Error("I can't decode the character at index " + f + " of " + a + " because it's not a valid UTF8 sequence.");
                        d.push(String.fromCharCode((k & 15) << 12 | (g & 63) << 6 | b & 63))
                    }
                }
            }
            return c + d.join("")
        ...
        utf8Encode: function(a) {
            ...
            if (c.length === a.length)
                return c;
            for (var d = [], g = c.length; g < a.length; ++g) {
                var b = a.charCodeAt(g);
                128 > b ? d.push(a.charAt(g)) : (2048 > b ? d.push(String.fromCharCode(b >> 6 | 192)) : (d.push(String.fromCharCode(b >> 12 | 224)),
                d.push(String.fromCharCode(b >> 6 & 63 | 128))),
                d.push(String.fromCharCode(b & 63 | 128)))
            }
            return c + d.join("")
        },
        utf8Length: function(a) {
            var c, d, g = 0;
            c = 0;
            for (d = a.length; c < d; c++)
                g = 128 > a.charCodeAt(c) ? g + 1 : 2048 > a.charCodeAt(c) ? g + 2 : g + 3;
            return g
        }
    }
}();
if (RightNow.UI && RightNow.UI.AbuseDetection)
    throw Error("The RightNow.UI.AbuseDetection namespace variable has already been defined somewhere.");
YUI().use("node-base", "node-core", function(a) {
    RightNow.UI = RightNow.UI || {};
    RightNow.UI.AbuseDetection = function() {
        ...
        return {
            ...
            getChallengeProvider: function(a) {
                if (!a || !a.challengeProvider)
                    throw "The server did not return a challenge provider.";
                try {
                    return eval(a.challengeProvider)
                } catch (c) {
                    throw "There was an error evaluating the challenge provider.  " + c;
                }
            },
            getDialogCaption: function(a) {
                return a ? a.dialogCaption : ""
            },
            doesResponseIndicateAbuse: function(d) {
                return d && d.responseText ? "==CHALLENGE REQUIRED==" === d.responseText.slice(0, 22) ? (a = !1,
                !0) : "==CHALLENGE INCORRECT==" === d.responseText.slice(0, 23) ? a = !0 : !1 : !1
            },
            Default: function(a) {
                this._requestResubmitHandler = a || RightNow.Event.createDelegate(this, this._requestResubmitHandler)
            }
        }
    }();
    RightNow.UI.AbuseDetection.Default.prototype = {
        ...
        _requestResubmitHandler: function() {
            var c = a.merge(this._requestObject.post || {}, this._challengeProvider.getInputs(this._abuseChallengeDivID));
            RightNow.Ajax.makeRequest(this._requestObject.url, c, this._requestObject)
        },
        ...
        _createDefaultDialog: function(c) {
            var d = this._abuse.getDialogCaption(c)
              , g = a.one("#" + this._abuseChallengeDivID)
              , b = {
                buttons: [{
                    text: RightNow.Interface.getMessage("OK_LBL"),
                    isDefault: !0,
              ...
              , g = a.Node.create("<div id='" + this._abuseChallengeDivID + "'></div>");
            this._dialog = RightNow.UI.Dialog.actionDialog(d, g, b);
            "undefined" !== typeof this._dialog.set && this._dialog.set("hideOn", [{
                eventName: "key",
                keyCode: "esc"
            }]);
            this._validationLink || (this._validationLink = a.Node.create('<a href="javascript:void(0)">' + this._abuse.getDialogCaption(c) + "</a>"),
            this._validationLink.on("click", function() {
                this._challengeProvider.focus(this._abuseChallengeDivID)
            }, this),
            this._errorMessageDiv = a.Node.create("<div>"),
            this._errorMessageDiv.appendChild(this._validationLink),
            g.insert(this._errorMessageDiv, "before"));
            this._validationLink.addClass("rn_Hidden");
            RightNow.UI.Dialog.addDialogEnterKeyListener(this._dialog, function(b, a) {
                "keyPressed" === b && "INPUT" === a[1].target.tagName && "text" === a[1].target.type && (a[1].halt(),
        ...
        _challengeHandler: function(c, d, g) {
            this._challengeProvider = this._abuse.getChallengeProvider(c);
            this._requestObject = d;
            this._dialog ? (this._dialog.setHeader(this._abuse.getDialogCaption(c)),
            this._clearDefaultDialog()) : this._createDefaultDialog(c);
            this._abuse.isRetry() && this._validationLink && (this._errorMessageDiv.addClass("rn_ErrorMessage rn_MessageBox"),
            ...
            this._challengeProvider.create(this._abuseChallengeDivID, this._abuse.options, RightNow.Event.createDelegate(this, function() {
                var b = "true";
                this._abuse.isRetry() ? (a.Lang.later(100, this, function() {
                    this._validationLink && this._validationLink.focus && this._validationLink.focus()
                }),
                b = "false") : this._dialog.showEvent.subscribe(this._challengeProvider.focus);
                this._dialog.body ? a.one(this._dialog.body).setAttribute("aria-busy", b) : this._dialog._content && a.one(this._dialog._content).setAttribute("aria-busy", b);
                this._dialog.show();
                this._dialog.disableButtons()
            }), this._dialog)
        },
        _clearDefaultDialog: function() {
            var a = document.getElementById(this._abuseChallengeDivID);
            a && (a.innerHTML = "<div style='height: 129px'><img src='" + RightNow.Env("coreAssets") + "images/indicator.gif'></div>");
            this._dialog && (a = this._dialog.get("contentBox").get("id") + "_c",
...
if (RightNow.Event)
    throw Error("The RightNow.Event namespace variable has already been defined somewhere.");
YUI().use("event-base", "event-custom-base", function(a) {
    RightNow.Event = function() {
        ...
        return {
            create: function(b, d) {
                c[b] || (c[b] = new a.CustomEvent(b,{
                    context: d || window
                }));
                return c[b]
            },
            fire: function(b, a) {
                return c[b] ? c[b].fire(b, [].slice.call(arguments, 1)) : !0
            },
            get: function(b) {
                return c[b] || null
            },
            ...
            on: function(b, a, d, g) {
                return (c[b] || this.create(b, d)).on(a, d, g)
            },
            subscribe: function(b, a, c, d) {
                "evt_formTokenUpdate" === b && g.push(c.instanceID);
                return this.on(b, a, c, d)
            },
            unsubscribe: function(b, a, d) {
                c[b] && c[b].detach(a, d)
            },
            ...
            isSameReportID: function(b, a) {
                return b && b[0] && b[0].filters && b[0].filters.report_id == a
            },
            getDataFromFiltersEventResponse: function(b, a, c) {
                b = b[0];
                var d = null;
                !b.filters || c && b.filters.report_id != c || ((c = b.filters.allFilters) ? c.filters && c.filters[a] && c.filters[a].filters ? d = c.filters[a].filters.data : c[a] && c[a].filters && (d = c[a].filters.data) : d = b.filters.data);
                return d
            },
            setNoSessionCookies: function(b) {
                d = b
            },
            ...
            setTestLoginCookie: function() {
                this.noSessionCookies() && (document.cookie = "cp_login_start=1;path=/;HttpOnly;secure")
            },
            browserHistoryManagementKey: "s",
            isHistoryManagerFragment: function() {
                this.isHistoryManagerFragment._valueToMatch = this.isHistoryManagerFragment._valueToMatch || new RegExp("#" + this.browserHistoryManagementKey + "=[A-Za-z0-9+/]+");
                return null !== window.location.hash.match(this.isHistoryManagerFragment._valueToMatch)
            },
            EventObject: function(b, a) {
                this.w_id = b && b.instanceID ? b.instanceID : null;
                this.data = a && a.data ? a.data : {};
                b && b.data && b.data.info && b.instanceID && (this.data.w_id = b.data.info.w_id,
                this.data.rn_contextData = b.data.contextData,
                this.data.rn_contextToken = b.data.contextToken,
                this.data.rn_timestamp = b.data.timestamp,
                this.data.rn_formToken = b.data.formToken,
                this.data.formTokenUpdateList = g);
                this.filters = a && a.filters ? a.filters : {}
            },
            EventBus: function() {
                function b(b, a) {
                    a = a[0];
                    RightNow.Ajax.makeRequest("/ci/ajaxRequestMin/getAccessibleTreeView", {
                        hm_type: a.data.hm_type,
                        linking_on: a.data.linkingProduct
                    }, {
                        successHandler: e,
                        scope: this,
                        data: a,
                ...
                function a(b, c) {
                    c = c[0];
                    RightNow.Ajax.makeRequest("/ci/ajaxRequestMin/getAccessibleProductCatalogTreeView", {
                        isSearchRequest: c.data.isSearchRequest
                    }, {
                        successHandler: g,
                        scope: this,
                        data: c,
                ...
                function d(b, a) {
                    a.data.newToken = b.newToken;
                    a.data.formTokenUpdateList = this.getWidgetsSubscribedToFTokUpdate();
                    this.fire("evt_formTokenUpdate", a)
                }
                function e(a, b) {
                    a && a.result ? (b.data.accessibleLinks = a.result,
                    this.fire("evt_accessibleTreeViewGetResponse", b)) : RightNow.UI.Dialog.messageDialog(a.suggestedErrorMessage || RightNow.Interface.getMessage("THERE_PROB_REQ_ACTION_COULD_COMPLETED_MSG"), {
                        icon: "WARN"
                    })
                }
                function g(a, b) {
                    a && a.result ? (b.data.accessibleLinks = a.result,
                    this.fire("evt_accessibleProductCatalogTreeViewGetResponse", b)) : RightNow.UI.Dialog.messageDialog(a.suggestedErrorMessage || RightNow.Interface.getMessage("THERE_PROB_REQ_ACTION_COULD_COMPLETED_MSG"), {
                        icon: "WARN"
                    })
                }
                function p(a, b) {
                    b = b[0];
                    var c;
                    b.data.link_map && (r = b.data.link_map);
                    if (!b.data.linking_on) {
                        if (5 < b.data.level)
                            return;
                        if (1 > b.data.value) {
                            b.data.level = 1;
                            b.data.hier_data = [];
                            this.fire("evt_menuFilterGetResponse", b);
                            return
                        }
                        if (b.data.cache[b.data.value]) {
                            c = new this.EventObject;
                            c.data = {
                                hier_data: b.data.cache[b.data.value],
                                level: b.data.level + 1
                            };
                            c.w_id = b.w_id;
                            this.fire("evt_menuFilterGetResponse", c);
                            return
                        }
                    } else if (-1 < b.data.data_type.toLowerCase().indexOf("cat") && r && r[b.data.value]) {
                        c = RightNow.Lang.cloneObject(b);
                        c.data.reset || c.data.level++;
                        c.data.hier_data = RightNow.Lang.cloneObject(r[c.data.value]);
                        c.data.via_filter_request = !0;
                        c.data.via_hier_request = !0;
                        this.fire("evt_menuFilterGetResponse", c);
                        return
                    }
                    RightNow.Ajax.makeRequest("/ci/ajaxRequestMin/getHierValues", {
                        linking: b.data.linking_on,
                        filter: b.data.data_type,
                        id: b.data.value
                    }, {
                        successHandler: t,
                        data: b,
                ...
                function l(b, a) {
                    a = a[0];
                    1 > a.data.value ? (a.data.level = 1,
                    a.data.hier_data = [],
                    this.fire("evt_menuFilterProductCatalogGetResponse", a)) : RightNow.Ajax.makeRequest("/ci/ajaxRequestMin/getHierValuesForProductCatalog", {
                        id: a.data.value,
                        level: a.data.level,
                        isSearchRequest: a.data.isSearchRequest
                    }, {
                        successHandler: n,
                        data: a,
                        type: "GETPOST",
                ...
                function n(b, a) {
                    if (b = b.result)
                        a.data.hier_data = b,
                        a.data.level++,
                        this.fire("evt_menuFilterProductCatalogGetResponse", a)
                }
                function q(b, a) {
                    a = a[0];
                    a.data.reset && (a.data.reset_linked_category && "Category" === a.data.data_type || "c" === a.data.name) && (r = null)
                }
                function t(b, a) {
                    if (b = b.result)
                        a.data.cache[a.data.value] = b[0],
                        a.data.hier_data = b[0],
                        a.data.level++,
                        a.data.via_hier_request = !0,
                        this.fire("evt_menuFilterGetResponse", a),
                        a.data.linking_on && -1 < a.data.data_type.toLowerCase().indexOf("prod") && (r = b.link_map,
                        this.fire("evt_menuFilterGetResponse", new this.EventObject(null,{
                            data: {
                                level: 1,
                                hier_data: r[0],
                                data_type: a.data.data_type.replace("Product", "Category"),
                                reset_linked_category: !0,
                                via_linking: !0
                            },
                            filters: {
                                report_id: a.filters.report_id
                            }
                        })),
                        a.data.value && -1 !== a.data.value || (r = null))
                }
                function w(a, b) {
                    var c = {
                        filter_type: b[0].data.data_type,
                        id: b[0].data.id,
                        f_tok: b[0].data.f_tok
                    };
                    this.fire("evt_menuFilterSettingResponse");
                    RightNow.Ajax.makeRequest("/ci/ajaxRequest/addOrRenewNotification", c, {
                        data: {
                            eventName: "evt_menuFilterSelectResponse"
                        }
                    })
                }
                var r = null;
                this.initializeEventBus = function() {
                    this.on("evt_menuFilterSelectRequest", w, this);
                    this.on("evt_menuFilterRequest", p, this);
                    this.on("evt_menuFilterRequestProductCatalog", l, this);
                    this.on("evt_menuFilterGetResponse", q, this);
                    this.on("evt_resetFilterRequest", q, this);
                    this.on("evt_accessibleTreeViewRequest", b, this);
                    this.on("evt_accessibleProductCatalogTreeViewRequest", a, this);
                    this.on("evt_formTokenRequest", c, this)
                }
            }
        }
    }();
    a.on("domready", function() {
        var a = RightNow.Event;
        a.EventBus = new a.EventBus;
        a.EventBus.initializeEventBus.call(a)
    })
});
